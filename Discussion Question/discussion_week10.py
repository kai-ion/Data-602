...
def main():
    ...
    print("###Q2### Image you are creating a visualization for a presentation at work.  What are some recommendations or guidelines you would follow to make engaging and informative visuals?")
    print("")
    print("\n")
